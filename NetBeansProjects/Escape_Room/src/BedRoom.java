...
public class BedRoom extends OurFrame {
    ...
    public void addcomponent() {
        backgroundImg = new MyImageIcon("resource/bedroom/bedroomBG.png");

        drawpane = new JLabel();
        drawpane.setIcon(backgroundImg);
        drawpane.setLayout(null);

        TeddyLabel = new JLabel(new MyImageIcon("resource/bedroom/teddy.png").resize(125, 160));
        TeddyLabel.setBounds(850, 390, 125, 160);
        TeddyLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));

        GotoCenterLabel = new JLabel(new MyImageIcon("resource/Arrow/Left.png").resize(64, 64));
        GotoCenterLabel.setBounds(50, 50, 64, 64);
        GotoCenterLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));

        ComLabel = new JLabel(new MyImageIcon("resource/bedroom/com.png").resize(170, 170));
...
class Compuzzle extends OurFrame {
    ...
    private MyImageIcon duckPurple, duckCyan, duckBlue, duckGreen, duckYellow, duckOrange, duckRed;
    ...
    public void addcomponent() {
        ...
        ComLabel = new JLabel(new MyImageIcon("resource/bedroom/compassword.png").resize(700, 500));
        ComLabel.setBounds(350, 50, 700, 500);
        ComLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));

        passBGLabel = new JLabel(new MyImageIcon("resource/bedroom/passBG.png").resize(1366, 668));
        passBGLabel.setBounds(0, 0, 1366, 668);

        duckPurple = new MyImageIcon("resource/bedroom/duckPurple.png").resize(100, 100);
        duckCyan = new MyImageIcon("resource/bedroom/duckCyan.png").resize(100, 100);
        duckBlue = new MyImageIcon("resource/bedroom/duckBlue.png").resize(100, 100);
        duckGreen = new MyImageIcon("resource/bedroom/duckGreen.png").resize(100, 100);
        duckYellow = new MyImageIcon("resource/bedroom/duckYellow.png").resize(100, 100);
        duckOrange = new MyImageIcon("resource/bedroom/duckOrange.png").resize(100, 100);
        duckRed = new MyImageIcon("resource/bedroom/duckRed.png").resize(100, 100);
        ...
        BackLabel = new JLabel(new MyImageIcon("resource/bedroom/back.png").resize(64, 64));
...
class Teddypuzzle extends OurFrame {
    ...
    private MyImageIcon backgroundImg, BacktImg;
    ...
    public void addcomponent() {
        ...
        BacktImg = new MyImageIcon("resource/bedroom/back.png").resize(64, 64);
        backgroundImg = new MyImageIcon("resource/bedroom/BGpopup.png").resize(1366, 668);
        
        drawpane = new JLabel(backgroundImg);
        drawpane.setLayout(null);
        
        TeddyBearLabel = new JLabel(new MyImageIcon("resource/bedroom/frontteddy.png").resize(800, 568));
        TeddyBearLabel.setBounds(300, 0, 800, 568);

        BackTeddyBearLabel = new JLabel(new MyImageIcon("resource/bedroom/backteddy.png").resize(800, 568));
...
class TeddyZip extends OurFrame {
    ...
    public void addcomponent() {
        ...
        BackTeddyBearLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));
                                                                                        //.resize(400, 400));
        ZipOpenLabel = new JLabel(new MyImageIcon("resource/bedroom/openteddy.png").resize(800, 568));
