...
public class Player {
    ...
    private ImageSet woodImg, tabeImg,keyImg,axeImg,ironImg,blackImg,bgImg,tapeblackImg,keyblackImg,axeblackImg,ironblackImg,woodblackImg;
    private SoundEffect roomsound, menusound, openroomsound, locksound, openpopupsound;
    private Ghost g;
    ...
    public void addItem() {
        ...
        blackImg = new ImageSet("resource/Item/Normal/black.png").resize(64, 64);
